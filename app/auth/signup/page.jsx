  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#4A9B8E] to-[#F59E0B] p-4">
      <motion.div 
        ...
        className="w-full max-w-md bg-white/20 backdrop-blur-lg rounded-2xl p-8 border border-white/30 shadow-xl"
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label htmlFor="confirmPassword" className="block text-white mb-2">{t('confirmPassword')}</label>
            <input
              type="password"
              id="confirmPassword"
        ...
        <p className="text-white/80 text-center mt-6">
          {t('accountExists')}{' '}
          <Link href="/auth/signin" className="text-[#F59E0B] font-semibold hover:underline">
            {t('signin')}
          </Link>
        </p>
      </motion.div>
